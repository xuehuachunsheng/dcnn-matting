...
def main():
    ...
    if args.solve_fg:
        from solve_fg_bg import solve_foreground_background
...
if __name__ == "__main__":
    img_path = './test_inputs/donkey.png'
    trimap_path = './test_inputs/donkeyTrimap.png'
    ...
    cv2.imwrite('./test_outputs/cf_matting_alpha.jpg', alpha)