...
public:
    ...
    void loadImage(uchar* im, const int height, const int width);
    void loadTrimap(uchar* trimap, const int height, const int width);
    ...
    void refineSample();
    void localSmooth();
    void solveAlpha(uchar* matting);
    void setMatte(uchar* matting);
